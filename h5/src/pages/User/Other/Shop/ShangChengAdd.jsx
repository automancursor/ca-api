...
export default function ShangChengAdd() {
  ...
  // const productDescriptionObj = JSON.parse(productDescription);
  // const [brand, setBrand] = useState(productDescriptionObj.brand);
  // console.log(brand)
