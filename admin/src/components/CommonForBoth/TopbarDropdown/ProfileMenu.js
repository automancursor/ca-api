...
// users
import avatar2 from "../../../assets/images/logo-light.png";
        ...
        return (
            <React.Fragment>
                        <Dropdown isOpen={this.state.menu} toggle={this.toggle} className="d-inline-block user-dropdown">
                            ...
                            <DropdownMenu right>
                                <DropdownItem href="#"><i className="ri-user-line align-middle mr-1"></i> {this.props.t('Admin详情')}</DropdownItem>
                                ...
                                <DropdownItem className="text-danger" href="/logout"><i className="ri-shut-down-line align-middle mr-1 text-danger"></i> {this.props.t('登出')}</DropdownItem>
                            </DropdownMenu>
                        </Dropdown>
            </React.Fragment>
        );
