      ...
      <React.Fragment>
        <div id="sidebar-menu">
          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            <li className="menu-title">{this.props.t('菜单')}</li>

            <li>
              <Link to="/dashboard" className="waves-effect">
                <i className="ri-dashboard-line"></i>
                <span className="ml-1">{this.props.t('仪表盘')}</span>
              </Link>
            </li>
            ...
            <li>
              <Link to="/members" className="waves-effect">
                ...
                <span className="ml-1">{this.props.t('会员管理')}</span>
              </Link>
            </li>

            <li>
              <Link to="/certification" className="waves-effect">
                <i className="ri-bank-card-line"></i>
                <span className="ml-1">{this.props.t('实名验证')}</span>
              </Link>
            </li>
            <li>
              <Link to="/shopcertification" className="waves-effect">
                <i className="ri-bank-card-line"></i>
                <span className="ml-1">{this.props.t('商户验证')}</span>
              </Link>
            </li>

            <li>
              <Link to="/referrers" className="waves-effect">
                <i className="ri-artboard-2-line"></i>
                <span className="ml-1">{this.props.t('推荐关系')}</span>
              </Link>
            </li>
            ...
            <li>
              <Link to="/orders" className="waves-effect">
                <i className="ri-artboard-2-line"></i>
                <span className="ml-1">{this.props.t('区块订单')}</span>
              </Link>
            </li>
            ...
            <li>
              <Link to="/category" className="waves-effect">
                ...
                <span className="ml-1">{this.props.t('产品类别')}</span>
              </Link>
            </li>
            ...
            <li>
              <Link to="/products" className="waves-effect">
                ...
                <span className="ml-1">{this.props.t('产品列表')}</span>
              </Link>
            </li>

            <li>
              <Link to="/productOrders" className="waves-effect">
                <i className="ri-store-2-line"></i>
                <span className="ml-1">{this.props.t('商城订单')}</span>
              </Link>
            </li>

            <li>
              <Link to="/RptProducts" className="waves-effect">
                <i className="ri-store-2-line"></i>
                <span className="ml-1">{this.props.t('积分产品')}</span>
              </Link>
            </li>

            <li>
              <Link to="/recharge" className="waves-effect">
                <i className="ri-money-dollar-circle-line"></i>
                <span className="ml-1">{this.props.t('充值记录')}</span>
              </Link>
            </li>

            <li>
              <Link to="/withdraw" className="waves-effect">
                <i className="ri-currency-line"></i>
                <span className="ml-1">{this.props.t('提现记录')}</span>
              </Link>
            </li>

            <li>
              <Link to="/transefer" className="waves-effect">
                <i className="ri-exchange-dollar-line"></i>
                <span className="ml-1">{this.props.t('互转记录')}</span>
              </Link>
            </li>

            <li>
              <Link to="/reimbursement" className="waves-effect">
                <i className="ri-eraser-fill"></i>
                <span className="ml-1">{this.props.t('补贴记录')}</span>
              </Link>
            </li>
            ...
            <li>
              <Link to="/banner" className="waves-effect">
                <i className="ri-pencil-ruler-2-line"></i>
                <span className="ml-1">{this.props.t('轮播图')}</span>
              </Link>
            </li>

            <li>
              <Link to="/block" className="waves-effect">
                <i className="ri-pencil-ruler-2-line"></i>
                <span className="ml-1">{this.props.t('区块设置')}</span>
              </Link>
            </li>
            ...
            <li>
              <Link to="/settings" className="waves-effect">
                <i className="ri-pencil-ruler-2-line"></i>
                <span className="ml-1">{this.props.t('系统设置')}</span>
              </Link>
            </li>
